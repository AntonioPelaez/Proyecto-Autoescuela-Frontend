...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    form.addEventListener("submit", async (e) => {
        ...
        const bookingId =
            document.getElementById("incident-booking").value || null;

        if (!type || !priority || !description) {
            showState(
                "error",
                "Tipo, prioridad y descripción son obligatorios.",
            );
            return;
        }
    ...
    filterForm.addEventListener("submit", async (e) => {
        ...
        const filters = {
            ...
            priority:
                document.getElementById("filter-priority").value || undefined,
            type: document.getElementById("filter-type").value || undefined,
            assigned:
                document.getElementById("filter-assigned").value || undefined,
            dateFrom:
                document.getElementById("filter-date-from").value || undefined,
            dateTo:
                document.getElementById("filter-date-to").value || undefined,
        };
        ...
        try {
            ...
            showState(
                "error",
                error.message || "Error al filtrar incidencias.",
            );
        } finally {
            UI.setLoading(false);
        }
    ...
    statusForm.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            document.getElementById("status-form-container").style.display =
                "none";
            await loadIncidents();
        } catch (error) {
    ...
    assignForm.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            document.getElementById("assign-form-container").style.display =
                "none";
            await loadIncidents();
        } catch (error) {
    ...
    function renderIncidents(incidents) {
        ...
        incidents.forEach((incident) => {
            ...
            row.querySelector(".btn-change-status").addEventListener(
                "click",
                (e) => {
                    const incidentId = e.target.dataset.id;
                    const currentStatus = e.target.dataset.status;
                    document.getElementById("status-incident-id").value =
                        incidentId;
            ...
            row.querySelector(".btn-assign").addEventListener("click", (e) => {
                ...
                document.getElementById("assign-incident-id").value =
                    incidentId;
            ...
            if (closeBtn) {
                closeBtn.addEventListener("click", async (e) => {
                    ...
                    try {
                        ...
                        showState(
                            "error",
                            error.message || "Error al cerrar incidencia.",
                        );
                    } finally {
                        UI.setLoading(false);
                    }
    ...
    function resetForm() {
        ...
        document.getElementById("incident-submit").textContent =
            "Crear Incidencia";
