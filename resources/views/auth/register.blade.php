    ...
    <div class="card auth-register-card">
        <div class="card-body">
            ...
            <form id="register-form" novalidate autocomplete="off" role="form" aria-label="Formulario de registro de alumno">
                ...
                {{-- Población --}}
                <div class="input-group">
                    <label for="reg-town" class="input-label">Población preferida <span class="req">*</span></label>
                ...
                <div class="input-group">
                    <label for="reg-password-confirm" class="input-label">Confirmar contraseña <span class="req">*</span></label>
                    <div class="input-password-wrap">
