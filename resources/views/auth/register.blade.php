...
<head>
    ...
    <meta name="description"
        content="Regístrate como alumno en la plataforma de AutoEscuela Pro y reserva tus primeras clases de conducir.">
    ...
    <div class="auth-register">
        ...
        <div class="card auth-register-card">
            <div class="card-body">
                ...
                <form id="register-form" novalidate autocomplete="off" role="form"
                    aria-label="Formulario de registro de alumno">

                    {{-- Nombre + Apellidos --}}
                    <div class="register-row">
                        <div class="input-group">
                            <label for="reg-name" class="input-label">Nombre <span class="req">*</span></label>
                            <input type="text" id="reg-name" name="name" class="input" placeholder="María"
                                autocomplete="given-name" required>
                            <span class="input-error" id="err-name"></span>
                        </div>

                        <div class="input-group">
                            <label for="reg-surname" class="input-label">Apellidos <span class="req">*</span></label>
                    ...
                    {{-- Email --}}
                    <div class="input-group">
                        <label for="reg-email" class="input-label">Email <span class="req">*</span></label>
                    ...
                    {{-- Teléfono --}}
                    <div class="input-group">
                        <label for="reg-phone" class="input-label">Teléfono <span class="req">*</span></label>
                        <input type="tel" id="reg-phone" name="phone" class="input" placeholder="6XX XXX XXX"
                            autocomplete="tel" required pattern="[6-9][0-9]{8}">
                        <span class="input-error" id="err-phone"></span>
                    </div>

                    {{-- Población --}}
                    <div class="input-group">
                        <label for="reg-town" class="input-label">Población <span class="req">*</span></label>
                    ...
                    {{-- Contraseña --}}
                    <div class="input-group">
                        <label for="reg-password" class="input-label">Contraseña <span class="req">*</span></label>
                    ...
                    <div class="input-group">
                        <label for="reg-password-confirm" class="input-label">Confirmar contraseña <span
                    ...
                    <div class="input-group register-terms">
                        <label class="register-terms-label">
                            ...
                            <span>He leído y acepto la <a href="#" class="link">política de privacidad</a> y
                                los <a href="#" class="link">términos de uso</a>.</span>
                        </label>
        ...
        <aside class="auth-register-aside" aria-label="Proceso de registro">
            ...
            <ol class="auth-register-steps">
                <li class="auth-register-step">
                    <span class="auth-register-step-num">1</span>
                    <div>
                ...
                <li class="auth-register-step">
                    <span class="auth-register-step-num">2</span>
                    <div>
                ...
                <li class="auth-register-step">
                    <span class="auth-register-step-num">3</span>
                    <div>
