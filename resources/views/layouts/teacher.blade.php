...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/profesor-panel.css') }}">
</head>
<body class="page-role page-role-teacher">
    ...
    <div class="container role-layout">
        <aside class="role-sidebar">
            <div class="card card-body">
                ...
                <nav class="role-menu" aria-label="Menu profesor">

                    <a href="/teacher/home"
                       class="role-menu-link {{ request()->is('teacher/home') ? 'is-active' : '' }}">
                        Panel
                    </a>

                    <a href="/teacher/bookings"
                       class="role-menu-link {{ request()->is('teacher/bookings') ? 'is-active' : '' }}">
                        Agenda
                    </a>

                    <a href="/teacher/classes"
                       class="role-menu-link {{ request()->is('teacher/classes') ? 'is-active' : '' }}">
                        Clases
                    </a>
                    ...
                    <a href="/teacher/profile"
                       class="role-menu-link {{ request()->is('teacher/profile') ? 'is-active' : '' }}">
                        Mi perfil
                    </a>
                ...
                <div class="role-sidebar-logout">
                    <button type="button" class="btn btn-danger btn-sm btn-full" data-action="logout">
                        Cerrar sesión
                    </button>
                </div>
            </div>
