...
@section('main-id', 'teacher-profile-main')

@section('content')
<div class="page-shell">

    <header class="page-shell-intro">
        <p class="welcome-home-eyebrow">Profesor</p>
        <h1>Mi perfil</h1>
        <p>Consulta y actualiza tus datos personales e información profesional.</p>
    </header>
...
@section('scripts')
<script src="{{ asset('js/pages/teacher-profile.js') }}" defer></script>
@endsection
